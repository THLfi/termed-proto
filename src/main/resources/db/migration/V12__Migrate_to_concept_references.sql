...
ALTER TABLE concept_references ALTER COLUMN type_id SET NOT NULL;
ALTER TABLE concept_references ALTER COLUMN source_id SET NOT NULL;
ALTER TABLE concept_references ALTER COLUMN target_id SET NOT NULL;
...
CREATE INDEX concept_references_type_id_idx ON ${schema}.concept_references(type_id);
